...
{
    protected $signature = 'onyx:application-parameter {--dry-run : Affiche les changements sans les appliquer}';
    ...
    public function handle(): int
    {
        ...
        $enumCases = OnyxApplicationParameterEnum::cases();
        $enumKeys = array_map(fn (OnyxApplicationParameterEnum $case): string => $case->value, $enumCases);
    ...
    /**
     * @param  OnyxApplicationParameterEnum[]  $enumCases
     ...
     */
    private function syncDescription(OnyxApplicationParameterEnum $case, array $existing, bool $dryRun): void
    {
